...
entity zynq_pwm_module_0_0_pwm_module is
  port (
  ...
  attribute ORIG_REF_NAME of zynq_pwm_module_0_0_pwm_module : entity is "pwm_module";
end zynq_pwm_module_0_0_pwm_module;

architecture STRUCTURE of zynq_pwm_module_0_0_pwm_module is
...
begin
  ...
  pwm(1) <= \^pwm\(0);
  pwm(0) <= \^pwm\(0);
U0: entity work.zynq_pwm_module_0_0_pwm_module
     port map (
      clk => clk,
