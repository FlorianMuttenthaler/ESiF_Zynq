...
HD_PWD='C:/GIT/ESiF_Zynq/Task2/ESiF_Task2/ESiF_Task2.runs/zynq_pwm_module_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_pwm_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_pwm_module_0_0.tcl
