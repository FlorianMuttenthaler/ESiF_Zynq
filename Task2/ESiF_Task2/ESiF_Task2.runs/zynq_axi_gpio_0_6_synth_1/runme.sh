...
HD_PWD='C:/GIT/ESiF_Zynq/Task2/ESiF_Task2/ESiF_Task2.runs/zynq_axi_gpio_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_gpio_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_gpio_0_6.tcl
