...
HD_PWD='C:/GIT/ESiF_Zynq/Task2/ESiF_Task2/ESiF_Task2.runs/zynq_processing_system7_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_processing_system7_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_processing_system7_0_3.tcl
